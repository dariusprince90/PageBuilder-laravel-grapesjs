...
<body>
    ...
    <div class="ad-cont" style="margin-top: 100px;">
        @if (isset($website))
            <form action="/website/{{ $website->id }}" method="post" id="website-form">
                @csrf
                @method('PUT')
                <label>Name</label>
        ...
        @else
            <form action="/website" method="post" id="website-form">
                @csrf
                <label>Name</label>
                <input type="hidden" name="id" value="99" />
                <input type="text" name="name" value="" />
                <label>URL</label>
                <input type="text" name="url" value="{{ url('/page') }}/" />
                <input type="submit" value="Submit" />
            </form>
        @endif
    </div>
    ...
    <script type="text/javascript">
            ...
            pluginsOpts: {
                ...
                'gjs-preset-webpage': {
                    ...
                    customStyleManager: [{
                        ...
                        name: 'Dimension',
                        open: false,
                        buildProps: ['width', 'flex-width', 'height', 'max-width', 'min-height', 'margin',
                            'padding'
                        ],
                        properties: [{
                            id: 'flex-width',
        ...
        editor.on('load', function() {
            ...
            // console.log("Maximus", document.querySelector('.gjs-logo-cont'));
            if (document.querySelector('.gjs-logo-cont')) {
